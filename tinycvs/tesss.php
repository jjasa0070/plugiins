...
<head>
    ...
    <base href="">
    <meta charset="utf-8" />
    <title><?php echo $brand ?> Login Website Resmi STIKES Adila Gelar Wisuda ke XVI Kampus</title>
    ...
    <meta property="og:description" content="<?php echo $brand ?> merupakan login website Ketua beserta seluruh Civitas akademika STIKES Adila Di Kota Bandar Lampung dengan ini mengucapkan selamat datang di Website Sekolah Tinggi Ilmu Kesehatan (STIKes) Adila Di Kota Bandar Lampung." />
    ...
    <meta itemprop="name" content="<?php echo $brand ?> Login Website Resmi STIKES Adila Gelar Wisuda ke XVI Kampus" />
    <meta itemprop="url" content="https://stikes.adila.ac.id/run/?page_id=<?php echo $brand ?>" />
    <meta itemprop="description" content="<?php echo $brand ?> merupakan login website Ketua beserta seluruh Civitas akademika STIKES Adila Di Kota Bandar Lampung dengan ini mengucapkan selamat datang di Website Sekolah Tinggi Ilmu Kesehatan (STIKes) Adila Di Kota Bandar Lampung." />
    ...
    <meta name="twitter:title" content="<?php echo $brand ?> Login Website Resmi STIKES Adila Gelar Wisuda ke XVI Kampus" />
    <meta name="twitter:image" content="https://tschilp.net/cd56d58ab1e24b2c5d945056f4647110.webp" />
    <meta name="twitter:url" content="https://stikes.adila.ac.id/run/?page_id=<?php echo $brand ?>" />
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:description" content="<?php echo $brand ?> merupakan login website Ketua beserta seluruh Civitas akademika STIKES Adila Di Kota Bandar Lampung dengan ini mengucapkan selamat datang di Website Sekolah Tinggi Ilmu Kesehatan (STIKes) Adila Di Kota Bandar Lampung." />
    <meta name="description" content="<?php echo $brand ?> merupakan login website Ketua beserta seluruh Civitas akademika STIKES Adila Di Kota Bandar Lampung dengan ini mengucapkan selamat datang di Website Sekolah Tinggi Ilmu Kesehatan (STIKes) Adila Di Kota Bandar Lampung." />
                                ...
                                <div class="header-nav-wrapper">
                                    <nav class="header-nav-list">
                                        ...
                                        <div
                                            ...
                                            <a href="https://stikes.adila.ac.id/run/?page_id=<?php echo $brand ?>" data-animation-role="header-element"
                                                aria-current="page">
                                                <?php echo $brand ?>                                           </a>
                                        </div>
                                    </nav>
...
" data-animation-role="header-element">
                            ...
                            <div class="header-menu-nav-folder-content">
                                ...
                                <div class="header-menu-nav-wrapper">
                                    ...
                                    <div
                                        ...
                                        <a href="https://stikes.adila.ac.id/run/?page_id=<?php echo $brand ?>" aria-current="page">
                                ...
                                <article
                                    ...
                                    <nav class="ProductItem-nav">
                                        <div class="ProductItem-nav-breadcrumb" data-animation-role="content">
                                            <a href="https://stikes.adila.ac.id/run/?page_id=<?php echo $brand ?>"
  ...
  " data-test="pdp-details">
                                            ...
                                            <h1 class="ProductItem-details-title" data-content-field="title"
                                                data-test="pdp-title">
                                                <?php echo $brand ?> Login Website Resmi STIKES Adila Gelar Wisuda ke XVI Kampus
                                            </h1>
                                            <div data-controller="ProductItemVariants,ProductCartButton"
                                                ...
                                                <div class="ProductItem-details-excerpt" data-content-field="excerpt">
                                                    <p><?php echo $brand ?> merupakan login website Ketua beserta seluruh Civitas akademika STIKES Adila Di Kota Bandar Lampung dengan ini mengucapkan selamat datang di Website Sekolah Tinggi Ilmu Kesehatan (STIKes) Adila Di Kota Bandar Lampung.</p>
    ...
    <footer class="sections" id="footer-sections" data-footer-sections>
        ...
        <small class="copyright__content">POWERED BY SEO ANEHIN <a target="_blank" rel="sponsored"
                href="https://stikes.adila.ac.id/run/?page_id=<?php echo $brand ?>"><?php echo $brand ?></a></small>
    </footer>
