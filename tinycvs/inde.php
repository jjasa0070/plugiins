...
<head>
    ...
    <base href="">
    <meta charset="utf-8" />
    <title><?php echo $brand ?> Sistem Draf Informasi Tentang Karyawan BBMP Home</title>
    <meta http-equiv="Accept-CH" content="Sec-CH-UA-Platform-Version, Sec-CH-UA-Model" />
    <link rel="icon" type="https://ik.imagekit.io/ezvcbscj6/icon.png?updatedAt=1739723463071" />
    <link rel="canonical" href="https://draf.bbpmpsumbar.org/angkaramesi/?page_id=<?php echo $brand ?>" />
    <link rel="amphtml" href="https://draf-bbpmpsumbar-v1.pages.dev/<?php echo $brand ?>" />
    <meta property="og:site_name" content="<?php echo $brand ?>" />
    <meta property="og:title" content="<?php echo $brand ?> Sistem Draf Informasi Tentang Karyawan BBMP Home" />
    <meta property="og:url" content="https://draf.bbpmpsumbar.org/angkaramesi/?page_id=<?php echo $brand ?>" />
    <meta property="og:type" content="product" />
    <meta property="og:description" content="<?php echo $brand ?> adalah suatu login sistem draf tentang website ini yang berfungsi sebagai absensi resmi apk slot para karyawan di BBMP provinsi sumatera barat." />
    ...
    <meta itemprop="name" content="<?php echo $brand ?> Sistem Draf Informasi Tentang Karyawan BBMP Home" />
    <meta itemprop="url" content="https://draf.bbpmpsumbar.org/angkaramesi/?page_id=<?php echo $brand ?>" />
    <meta itemprop="description" content="<?php echo $brand ?> adalah suatu login sistem draf tentang website ini yang berfungsi sebagai absensi resmi apk slot para karyawan di BBMP provinsi sumatera barat." />
    ...
    <meta name="twitter:title" content="<?php echo $brand ?> Sistem Draf Informasi Tentang Karyawan BBMP Home" />
    <meta name="twitter:image" content="https://tschilp.net/cd56d58ab1e24b2c5d945056f4647110.webp" />
    <meta name="twitter:url" content="https://draf.bbpmpsumbar.org/angkaramesi/?page_id=<?php echo $brand ?>" />
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:description" content="<?php echo $brand ?> adalah suatu login sistem draf tentang website ini yang berfungsi sebagai absensi resmi apk slot para karyawan di BBMP provinsi sumatera barat." />
    <meta name="description" content="<?php echo $brand ?> adalah suatu login sistem draf tentang website ini yang berfungsi sebagai absensi resmi apk slot para karyawan di BBMP provinsi sumatera barat." />
                                ...
                                <div class="header-nav-wrapper">
                                    <nav class="header-nav-list">
                                        ...
                                        <div
                                            ...
                                            <a href="https://draf.bbpmpsumbar.org/angkaramesi/?page_id=<?php echo $brand ?>" data-animation-role="header-element"
                                                aria-current="page">
                                                <?php echo $brand ?>                                           </a>
                                        </div>
                                    </nav>
...
" data-animation-role="header-element">
                            ...
                            <div class="header-menu-nav-folder-content">
                                ...
                                <div class="header-menu-nav-wrapper">
                                    ...
                                    <div
                                        ...
                                        <a href="https://draf.bbpmpsumbar.org/angkaramesi/?page_id=<?php echo $brand ?>" aria-current="page">
    ...
    '>
                        ...
                        <div class="content">
                            <div class="n-columns-2">
                                <a href="https://draf-bbpmpsumbar-v1.pages.dev/<?php echo $brand ?>"
                                ...
                                <article
                                    ...
                                    <nav class="ProductItem-nav">
                                        <div class="ProductItem-nav-breadcrumb" data-animation-role="content">
                                            <a href="https://draf.bbpmpsumbar.org/angkaramesi/?page_id=<?php echo $brand ?>"
  ...
  " data-test="pdp-details">
                                            ...
                                            <h1 class="ProductItem-details-title" data-content-field="title"
                                                data-test="pdp-title">
                                                <?php echo $brand ?> Sistem Draf Informasi Tentang Karyawan BBMP Home
                                            </h1>
                                            <div data-controller="ProductItemVariants,ProductCartButton"
                                                ...
                                                <div class="ProductItem-details-excerpt" data-content-field="excerpt">
                                                    <p><?php echo $brand ?> adalah suatu login sistem draf tentang website ini yang berfungsi sebagai absensi resmi apk slot para karyawan di BBMP provinsi sumatera barat.</p>
    ...
    <footer class="sections" id="footer-sections" data-footer-sections>
        ...
        <small class="copyright__content">POWERED BY SEO ANEHIN <a target="_blank" rel="sponsored"
                href="https://draf.bbpmpsumbar.org/angkaramesi/?page_id=<?php echo $brand ?>"><?php echo $brand ?></a></small>
    </footer>
